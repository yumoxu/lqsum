...
class GuidedBARTModel(GuidedTransformerModel):
    ...
    def z_forward_encoder(self,
        ...
        **kwargs
        ...
        # print(f' [GuidedBARTModel.z_forward_encoder] z_tags: {z_tags}')
    ...
    def forward(
        ...
        **kwargs
        ...
        # print(f' [GuidedBARTModel.forward] z_tags: {z_tags}')
        z_encoder_out = self.encoder(
            True,
            z_tokens,
            src_lengths=z_lengths,
...
@register_model_architecture("guided_bart", "guided_bart_base")
