#!/bin/sh
# Ablation study for 64: no posterior dropout (using only estimated tags)
# add: --fixed-oracle-tag-prob 0.0 
# remove: --oracle-anneal-end-value 0.5
ARCH=guided_bart_large_with_tagging
TAGGING_HEAD=binary_classification

LOG_DIR=/home/lqsum/log/model_69-bpeTags
